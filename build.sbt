...
organization := "com.konukhov"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/konukhov/downloader"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/konukhov/downloader"),
    "scm:git:https://github.com/konukhov/downloader.git",
    Some("scm:git:git@github.com:konukhov/downloader.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("com.konukhov.downloader.Server")

mainClass in (Compile, run) := Some("com.konukhov.downloader.Server")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("com.konukhov.downloader.Main")
